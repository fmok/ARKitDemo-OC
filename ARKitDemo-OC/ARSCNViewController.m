...
{
    _sunNode = [SCNNode new];  // 太阳
    _mercuryNode = [SCNNode new];  // 水星
    _venusNode = [SCNNode new];  // 金星
    _earthNode = [SCNNode new];  // 地球
    _moonNode = [SCNNode new];  // 月球
    _earthGroupNode = [SCNNode new];  // 地球group
    _marsNode = [SCNNode new];  // 火星
    _jupiterNode = [SCNNode new];  // 木星
    _saturnNode = [SCNNode new];  // 土星
    _sartunGruopNode = [SCNNode new];  // 土星group
    _uranusNode = [SCNNode new];  // 天王星
